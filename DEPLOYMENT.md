...
- [Deployment\sample-imports\Basic_N10-009_Quiz_Import_Package.zip](Deployment/sample-imports/Basic_N10-009_Quiz_Import_Package.zip): bundled quiz import package for post-install validation
...
Step 10: Copy [TheCertMaster-Deployment-Package.zip](Deployment/TheCertMaster-Deployment-Package.zip) to the server.
